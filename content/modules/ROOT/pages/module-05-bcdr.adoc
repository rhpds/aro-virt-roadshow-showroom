...
. Click on the operator to see its details.
...
. Navigate back to *Virtualization* and click  *Virtual Machines* in the left-side menu and confirm that the *fedora02* virtual machine was restored (in the *vmexamples-{user}* project). You can see its *Created* value should be a quite short time ago.
+
