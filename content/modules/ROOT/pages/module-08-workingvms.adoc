...
. When the page loads, you will see an error, something must be wrong. This is because the Windows web servers are not currently able to connect to the database VM after its migration.
+
